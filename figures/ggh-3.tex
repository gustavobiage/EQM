...
\begin{tikzpicture}
				...
				\begin{scope}
								...
								\tkzfundamentalpar{0}{0}{4}{3}{1}{0.2}{0}{0.5}{18}
								...
								% ciphered message
								\node (ciphertext) at (\offsetx + \mi*\ax + \mj*\bx - \errorx, \offsety + \mi*\ay + \mj*\by - \errory) [fill, circle, scale=0.3, blue] {};
				...
				\begin{scope}
								...
								\tkzlattice{6}{0}{4}{3}{1}{0.2}{0}{0.5}{5}
								...
								% ciphered message
								\node (ciphertext) at (\offsetx + 2*\ax + 3*\bx - 0.3, \offsety +  2*\ay + 3*\by - \errory) [fill, circle, scale=0.3, blue] {};
								\node [left = 0.001cm of ciphertext, node distance=0.5cm, blue] {\tiny $c$};
