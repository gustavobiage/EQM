...
\begin{tikzpicture}
    \centering
		...
		\tkzperfectradius{0}{4}{3}{1}{0}{0}{0.5}{7}

    \begin{scope}[opacity=0.25]
	   \tkzfundamentalpar{0}{0}{4}{3}{1}{0}{0}{0.5}{10}
    \end{scope}

    \tkzlattice{0}{0}{4}{3}{1}{0}{0}{0.5}{7}
    ...
    \node[blue, left = 0.001cm] at (\offsetx + 2*\ax + 3*\bx - 0.3, \offsety +  2*\ay + 3*\by - 0.1) {\tiny $c$};
		...
		\begin{scope}
						...
						\tkzdecodingradius{6}{0.4}{4}{3}{1}{0}{0}{0.5}{7}

						\begin{scope}[opacity=0.25]
										\tkzfundamentalpar{6}{0}{4}{3}{1}{0}{0}{0.5}{10}
						\end{scope}

						\tkzlattice{6}{0}{4}{3}{1}{0}{0}{0.5}{7}
