...
\begin{tikzpicture}
    ...
    \node (rect) at (1.5, -1) [rectangle, draw=black, line width=0.0125cm, minimum width=5cm, minimum height=0.5575cm] {$\sk = {\color{green}O} \in \OOn$};
        ...
        \node (rect2) at (7.5, -1) [rectangle, draw=black, line width=0.0125cm, minimum width=5cm, minimum height=0.5575cm] {$\pk =$ {\color{red}$\basisB'$}, s.t $\LL({\color{red}\basisB'}) = O \cdot \LL(\basisB)$};
\end{tikzpicture}
