...
\begin{tikzpicture}
				...
				\begin{scope}
								...
								\tkzdecodingradius{0}{0.25}{4}{3}{0.5}{0}{0.25}{0.43301}{9}

								\begin{scope}[opacity=0.25]
												\tkzfundamentalpar{0}{0}{4}{3}{0.5}{0}{0.25}{0.43301}{8}
								\end{scope}

								\tkzlattice{0}{0}{4}{3}{0.5}{0}{0.25}{0.43301}{7}
								...
								% ciphered message
								\node at (\offsetx + 2*\ax + 3*\bx - 0.065, \offsety +  2*\ay + 3*\by + 0.18) [fill, circle, scale=0.3, blue] {};

								\node[blue, left = 0.001cm] at (\offsetx + 2*\ax + 3*\bx - 0.065, \offsety +  2*\ay + 3*\by + 0.18) {\tiny $c$};
				...
				\begin{scope}
								...
								\begin{scope}[opacity=0.05]
												\tkzdecodingradius{6}{0.25}{4}{3}{0.5}{0}{0.25}{0.43301}{10}
								\end{scope}

								\tkzdecodingradius{6}{0.25}{4}{3}{1}{0}{0.25}{0.43301}{8}

								\begin{scope}[opacity=0.25]
												\tkzfundamentalpar{6}{0}{4}{3}{1.25}{0.43301}{0.25}{0.43301}{10}
								\end{scope}

								\tkzlattice{6}{0}{4}{3}{1.25}{0.43301}{0.25}{0.43301}{8}
				...
				\node (rect2) at (7.5, -1) [rectangle, draw=black, line width=0.0125cm, minimum width=5cm, minimum height=0.5575cm] {$\pk =$ {\color{red}$\basisH$}, s.t $\LL({\color{red}\basisH}) \subset \LL({\color{green}\basisB})$};
\end{tikzpicture}
